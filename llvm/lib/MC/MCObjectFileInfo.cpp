...
void MCObjectFileInfo::initELFMCObjectFileInfo(const Triple &T, bool Large) {
  ...
  // Section directive for the VIAMPP CPU 
//  VIAMPPRegSection = Ctx->getELFSection(".viampp", ELF::SHT_PROGBITS, ELF::SHF_ALLOC);
//  VIAMPPRegSection = Ctx->getELFSection(".viampp", ELF::SHT_LOPROC, ELF::SHF_MERGE);
  VIAMPPRegSection = Ctx->getELFSection(".viampp", ELF::SHT_VIAMPP_REGINFO, ELF::SHF_MERGE);
