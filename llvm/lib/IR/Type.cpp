...
IntegerType *Type::getInt8Ty(LLVMContext &C) { return &C.pImpl->/*Int8Ty*/Int64Ty; }	// for Viampp
IntegerType *Type::getInt16Ty(LLVMContext &C) { return &C.pImpl->/*Int16Ty*/Int64Ty; }	// for Viampp
IntegerType *Type::getInt32Ty(LLVMContext &C) { return &C.pImpl->/*Int32Ty*/Int64Ty; }	// for Viampp
...
PointerType *Type::getInt8PtrTy(LLVMContext &C, unsigned AS) {
  return /*getInt8Ty*/getInt64Ty(C)->getPointerTo(AS);		// for viampp
}

PointerType *Type::getInt16PtrTy(LLVMContext &C, unsigned AS) {
  return /*getInt16Ty*/getInt64Ty(C)->getPointerTo(AS);		// for Viampp
}

PointerType *Type::getInt32PtrTy(LLVMContext &C, unsigned AS) {
  return /*getInt32Ty*/getInt64Ty(C)->getPointerTo(AS);		// for Viampp
}
