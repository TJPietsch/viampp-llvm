...
unsigned StringLiteral::mapCharByteWidth(TargetInfo const &Target,
                                         StringKind SK) {
//llvm::outs() << "Expr.cpp: mapCharByteWidth: StringKind: " << SK << "\n";

  unsigned CharByteWidth = 0;
  switch (SK) {
  case Ascii:
  case UTF8:
//llvm::outs() << "Expr.cpp: mapCharByteWidth: Ascii, UTF8\n";
    CharByteWidth = Target.getCharWidth();
    break;
  case Wide:
//llvm::outs() << "Expr.cpp: mapCharByteWidth: Wide\n";    CharByteWidth = Target.getWCharWidth();
    break;
  case UTF16:
//llvm::outs() << "Expr.cpp: mapCharByteWidth: UTF16\n";    CharByteWidth = Target.getChar16Width();
    break;
  case UTF32:
//llvm::outs() << "Expr.cpp: mapCharByteWidth: UTF32\n";    CharByteWidth = Target.getChar32Width();
    break;
  }

//llvm::outs() << "Expr.cpp: mapCharByteWidth: before CharByteWidth: " << CharByteWidth << "\n";
  assert((CharByteWidth & 7) == 0 && "Assumes character size is byte multiple");
  CharByteWidth /= 8;
  assert((CharByteWidth == 1 || CharByteWidth == 2 || CharByteWidth == 4 || CharByteWidth == 8) &&	// for Viampp
         "The only supported character byte widths are 1,2/* and 4!*/,4 and 8!");			// for Viampp

//llvm::outs() << "Expr.cpp: mapCharByteWidth: after CharByteWidth: " << CharByteWidth << "\n";
...
//llvm::outs() << "Expr.cpp: StringLiteral(1)\n";

  assert(Ctx.getAsConstantArrayType(Ty) &&
         "StringLiteral must be of constant array type!");
  unsigned CharByteWidth = mapCharByteWidth(Ctx.getTargetInfo(), Kind);
  unsigned ByteLength = Str.size();
//llvm::outs() << "Expr.cpp: StringLiteral(1): CharByteWidth: " << CharByteWidth << " ByteLength: " << ByteLength << "\n";
...
//llvm::outs() << "Expr.cpp: StringLiteral(1): Length: " << Length << " NumConcatenated: " << NumConcatenated << "\n";
...
//llvm::outs() << "Expr.cpp: StringLiteral(2)\n";
...
StringLiteral *StringLiteral::Create(const ASTContext &Ctx, StringRef Str,
                                     ...
                                     const SourceLocation *Loc,
                                     unsigned NumConcatenated) {
//llvm::outs() << "Expr.cpp: *StringLiteral::Create\n";
...
//llvm::outs() << "Expr.cpp: *StringLiteral::CreateEmpty\n";
...
llvm::outs() << "Expr.cpp: outputString\n";
...
//llvm::outs() << "expr.cpp: getLocationOfByte\n";
