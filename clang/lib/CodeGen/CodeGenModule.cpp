...
//llvm::outs() << "CodeGenModule.cpp: GetConstArrayFromStringLiteral: getCharByteWidth: " << E->getCharByteWidth() << "\n";

  auto *AType = cast<llvm::ArrayType>(getTypes().ConvertType(E->getType()));
  llvm::Type *ElemTy = AType->getElementType();
  unsigned NumElements = AType->getNumElements();

//llvm::outs() << "CodeGenModule.cpp: GetConstArrayFromStringLiteral: primitiveSizeInBits: " << ElemTy->getPrimitiveSizeInBits() << "  getLength() " << E->getLength() << "\n";
//llvm::outs() << "CodeGenModule.cpp: getCharAlign: " << Context.getTargetInfo().getCharAlign() << "\n";

  // Don't emit it as the address of the string, emit the string data itself
  // as an inline array.
  if (E->getCharByteWidth() == 1) {
    if (Context.getTargetInfo().getCharAlign() == 8) {
//      llvm::outs() << "CodeGenModule.cpp: GetConstArrayFromStringLiteral: getCharByteWidth() == 1 && CharAlign == 8\n";
    ...
    if (Context.getTargetInfo().getCharAlign() == 64) {
//      llvm::outs() << "CodeGenModule.cpp: GetConstArrayFromStringLiteral: getCharByteWidth() == 1 && CharAlign == 64\n";
...
//llvm::outs() << "CodeGenModule.cpp: getPrimitiveSizeInBits() == 16\n";
...
//llvm::outs() << "CodeGenModule.cpp: GetConstArrayFromStringLiteral: getPrimitiveSizeInBits() == 32\n";
  ...
  assert(ElemTy->getPrimitiveSizeInBits() == 64);
//llvm::outs() << "CodeGenModule.cpp: GetConstArrayFromStringLiteral: getPrimitiveSizeInBits() == 64\n";
  SmallVector<uint64_t, 32> Elements;
  Elements.reserve(NumElements);
