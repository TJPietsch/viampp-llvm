...
TargetInfo::TargetInfo(const llvm::Triple &T) : TargetOpts(), Triple(T) {
  ...
  CharWidth = 8;	// for Viampp, defaults here, overwritten in Targets/Viampp.h
  CharAlign = 8;	// for Viampp, defaults here, overwritten in Targets/Viampp.h
  ShortWidth = 16;	// for Viampp, defaults here, overwritten in Targets/Viampp.h
  ShortAlign = 16;	// for Viampp, defaults here, overwritten in Targets/Viampp.h
  ...
  WCharType = SignedInt;	// for Viampp, defaults here, overwritten in Targets/Viampp.h
  WIntType = SignedInt;		// for Viampp, defaults here, overwritten in Targets/Viampp.h
  Char16Type = UnsignedShort;	// for Viampp, defaults here, overwritten in Targets/Viampp.h
  Char32Type = UnsignedInt;	// for Viampp, defaults here, overwritten in Targets/Viampp.h
