...
struct TransferrableTargetInfo {
  ...
  unsigned char CharWidth, CharAlign;	// for Viampp
  unsigned char ShortWidth, ShortAlign;	// for Viampp
  ...
  // If true, unsigned fixed point types have the same number of fractional bitsgetcharwidth
...
//  unsigned getCharAlign() const { return 8; } // FIXME
  unsigned getCharWidth() const { return CharWidth; } // for Viampp
  unsigned getCharAlign() const { return CharAlign; } // for Viampp

  /// Return the size of 'signed short' and 'unsigned short' for this
  /// target, in bits.
//  unsigned getShortWidth() const { return 16; } // FIXME
  unsigned getShortWidth() const { return ShortWidth; } // for Viampp

  /// Return the alignment of 'signed short' and 'unsigned short' for
  /// this target.
//  unsigned getShortAlign() const { return 16; } // FIXME
  unsigned getShortAlign() const { return ShortAlign; } // for Viampp
