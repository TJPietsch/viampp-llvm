...
private:
  ...
  char *getStrDataAsChar() { //llvm::outs() << "Expr.h: getStrDataAsChar\n";
     return getTrailingObjects<char>(); }
  const char *getStrDataAsChar() const { //llvm::outs() << "Expr.h: const getStrDataAsChar\n";
     return getTrailingObjects<char>(); }

  const uint16_t *getStrDataAsUInt16() const { //llvm::outs() << "Expr.h: getStrDataAsUInt16\n";
    return reinterpret_cast<const uint16_t *>(getTrailingObjects<char>());
  }

  const uint32_t *getStrDataAsUInt32() const { //llvm::outs() << "Expr.h: getStrDataAsUInt32\n";
    return reinterpret_cast<const uint32_t *>(getTrailingObjects<char>());
  }

  const uint64_t *getStrDataAsUInt64() const { //llvm::outs() << "Expr.h: getStrDataAsUInt64\n";	// for Viampp
    return reinterpret_cast<const uint64_t *>(getTrailingObjects<char>());			// for Viampp
  }
...
llvm::outs() << "Expr.h: getBytes\n";
  ...
  /*uint32_t*/uint64_t getCodeUnit(size_t i) const {
//llvm::outs() << "Expr.h: getCodeUnit: getCharByteWidth: " << getCharByteWidth() << "\n";
...
default:					// for Viampp
      return getStrDataAsUInt64()[i];		// for Viampp
    }
